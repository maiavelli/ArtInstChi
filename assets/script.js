    ...
    fetch(requestUrl)
        ...
        .then(function (data) {
            ...
            //populate elements with relevant data
                ...
                var imageRetrieve = imageURL + "/" + data['data'][i]['image_id'] + "/full/600,/0/default.jpg";
                var image = document.createElement('img');
                image.src = imageURL + "/" + data['data'][i]['image_id'] + "/full/600,/0/default.jpg";
...
submitBtn.addEventListener("click", function(){
    getApi();const searchInput = document.getElementById('inputValue');
